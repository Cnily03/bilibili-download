Promise.all([
    ...
    j(
        "https://cdn.jsdelivr.net/gh/Cnily03/bilibili-download@master/min/bilibili-evolved/GM_info.js"
    ),
    j(
        "https://cdn.jsdelivr.net/gh/Cnily03/bilibili-download@master/min/tampermonkeyEnv.js"
    ),
]).then(() => {
    j(
